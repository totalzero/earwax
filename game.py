...
class Menu:
    def __init__(self, keys):
        ...
        self.mission_menu = ['trening', 'misja1', 'misja2', 'powrot']
        self.focuscounter = 0
        ...
        self.misja2 = GameEngine.Gra(keys=self.keys, area=areas.misja2_ulica_start, special=-4, tasklog='znajdz i zneutralizuj wszystkie bomby')
